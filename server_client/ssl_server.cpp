...
#define SIZE 50
char buf1[] = "Please enter your user name";
char buf2[] = "Username already exists";
char buf3[] = "The IP duplicate login";
char buf4[] = "Login successful";
char buf5[] = "Please enter a password";
char buf6[] = "User does not exist";
char buf7[] = "Successful registration";
char buf8[] = "Password input error";
...
void printuser(user *root,SSL *ssl)
{
	...
	char data[] = "The current list of online users:";
	//printf("%s\n",(*root)->next->name);
	printf("The current list of online users:\n");
	SSL_write(ssl,data,strlen(data));
	while(q != NULL)
	{
		if(q->ssl != NULL)
